...
import ScalingPlanQns from "./ScalingPlanQns.jsx";
...
export default function ScalingPlan() {
  return (
    <div className="max-w-2xl mx-auto p-4">
      <div className="mb-6">
        <h1 className="text-3xl font-bold mb-2">Scaling Plan</h1>
      ...
      <p className="text-sm text-gray-500 mb-4">
        {ScalingPlanQns.length} articles
      </p>

      {ScalingPlanQns.map((item, id) => (
        <Card
          key={item.id}
        ...
        >
          <CardContent className="p-4">
            <Link
              to={`/faq/scaling-plan/${item.routerLink}`}
