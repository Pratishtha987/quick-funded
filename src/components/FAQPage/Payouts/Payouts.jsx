...
import PayoutsQns from "./PayoutsQns.jsx";
...
export default function Payouts() {
  return (
    <div className="max-w-2xl mx-auto p-4">
      ...
      <p className="text-sm text-gray-500 mb-4">{PayoutsQns.length} articles</p>

      {PayoutsQns.map((item, id) => (
        <Card
          key={item.id}
        ...
        >
          <CardContent className="p-4">
            <Link
              to={`/faq/payouts/${item.routerLink}`}
