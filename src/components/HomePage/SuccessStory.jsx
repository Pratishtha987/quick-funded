...
//             <button className="px-3 py-1 text-gray-600 border border-gray-300 rounded hover:bg-gray-100">
//               Client Area
//             </button>
...
const SuccessStory = () => {
 ...
 bg-white"
    >
      <div className="max-w-4xl mx-auto px-4 py-8">
        <h2 className="flex justify-center  text-[60px] font-bold bg-clip-text bg-[linear-gradient(90deg,#88B92F_0%,#109523_100%)] text-transparent mb-4  sm:text-[40px] md:justify-center">
          Success Stories
        </h2>
